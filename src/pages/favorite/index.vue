<template>
<!-- <q-card flat bordered class="col-xl-5 col-lg-5 col-md-6 col-sm-12 col-xs-12 bg-white row"> -->
  <q-pull-to-refresh ref="pullToRefresh" :disable="is_mobile_size"  @refresh="refresh" class="col-xl-5 col-lg-5 col-md-6 col-sm-12 col-xs-12 bg-white">
    <Tab ref="container" />
  </q-pull-to-refresh>
<!-- </q-card> -->
</template>
...
import { useYoutubeListStore } from 'src/stores/youtube/list-favorite.js'
