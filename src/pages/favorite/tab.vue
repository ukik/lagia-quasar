<template>
  <!-- <div class="col-xl-5 col-lg-5 col-md-6 col-sm-12 col-xs-12 bg-white scroll"> -->
  <q-tabs inline-label no-caps outside-arrows align="center" breakpoint="0" :mobile-arrows="is_mobile_size && !is_cordova"
    dense v-model="tab_favorite" class="text-dark col-12 text-weight-regular">
  ...
  <q-tab-panels id="mypanel" class="col-12 bg-white" v-model="tab_favorite" keep-alive animated>
...
import TabAudio from "./audio/list/index.vue"
import TabImage from "./image/list/index.vue"
import TabVideo from "./video/list/index.vue"
