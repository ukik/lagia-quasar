<template>
  <q-list class="row bg-white col-12">
    ...
    <YouTube v-if="item?.file" :height="is_mobile_size ? 250 : 350" :width="clientWidth"
      :src="item?.file"
      @ready="onReady"
    ...
    <template v-for="(value, index) in item?.comments">
      ...
      <div class="col-12 row flex justify-start">
        <TombolBalasKomentar @onBubbleEventReply="() => reply = value" :id="value?.id" name="youtube_komentar_balasan" />
