  ...
  <q-list bordered v-if="item">
    <q-expansion-item group="somegroup1" header-class="bg-grey-1" default-opened>
      <template v-slot:header>
        ...
        <q-item-section class="text-h6 text-dark"> PROFILE TOKO </q-item-section>
      </template>
      <q-separator />

      <q-card>
        <q-card-section>
          <PriceReferenceStore :item="item?.souvenirStore"></PriceReferenceStore>
        </q-card-section>
      </q-card>
    </q-expansion-item>
    ...
    <q-expansion-item group="somegroup" header-class="bg-grey-1" default-opened>
      <template v-slot:header>
        ...
        <q-item-section class="text-h6 text-dark"> DETAIL SOUVENIR </q-item-section>
      </template>
      <q-separator />
      <q-card>
        <q-card-section>
