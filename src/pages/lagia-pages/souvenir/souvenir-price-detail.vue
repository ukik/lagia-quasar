...
import { useSouvenirPriceDetailStore } from "stores/lagia-stores/souvenir/SouvenirPriceDetailStore";
...
defineOptions({
  ...
  //   return useSouvenirPriceDetailStore(store).onFetch(currentRoute?.params?.slug);
  // }
  preFetch: preFetch(
    ({
      store,
...
const $store = useSouvenirPriceDetailStore();
const {
  dataType,
  record,
  isMaintenance,
...
// import { useSouvenirPriceDetailStore } from "stores/lagia-stores/travel/SouvenirPriceDetailStore";
// import { useAuthStore } from "src/stores/lagia-stores/auth/AuthStore";
...
//     const $store = useSouvenirPriceDetailStore(store);
