...
import { useSouvenirDetailStore } from "stores/lagia-stores/souvenir/SouvenirDetailStore";
...
defineOptions({
  ...
  //   return useSouvenirDetailStore(store).onFetch(currentRoute?.params?.slug);
  // }
  preFetch: preFetch(
    ({
      store,
...
const $store = useSouvenirDetailStore();
const {
  dataType,
  record,
  isMaintenance,
...
// import { useSouvenirDetailStore } from "stores/lagia-stores/travel/SouvenirDetailStore";
// import { useAuthStore } from "src/stores/lagia-stores/auth/AuthStore";
...
//     const $store = useSouvenirDetailStore(store);
