...
import SouvenirPriceDialog from "./components/SouvenirPriceDialog.vue";
...
onBeforeRouteLeave((to, from, next) => {
  ...
  if (souvenir_store.value) dialog = true;
...
export default {
  ...
  //   // if (this.souvenir_store) return (this.souvenir_store = false);
