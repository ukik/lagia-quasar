          ...
          <q-card-section :horizontal="$q.screen.width > 768" class="row q-pa-none">
            ...
            <q-card-section class="bg-grey-2 row col flex items-start">
              <div class="text-box full-width q-px-sm col-12 text-capitalize">
                ...
                <q-item dense>
                  <q-item-section>
                    <q-item-label lines="1">Sejak</q-item-label>
                  </q-item-section>
                  <q-item-section side>
                    <q-item-label lines="1">{{
                      $formatDate(item?.yearExp)
                    }}</q-item-label>
                  </q-item-section>
                </q-item>
                <q-item
...
import { useTalentSkillListStore } from "stores/lagia-stores/talent/TalentSkillListStore";
import { useRouter } from "vue-router";
const store = useTalentSkillListStore();
