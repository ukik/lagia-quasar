...
import { useTalentPriceDetailStore } from "stores/lagia-stores/talent/TalentPriceDetailStore";
...
defineOptions({
  ...
  //   return useTalentPriceDetailStore(store).onFetch(currentRoute?.params?.slug);
  // }
  preFetch: preFetch(
    ({
      store,
...
const $store = useTalentPriceDetailStore();
const {
  dataType,
  record,
  isMaintenance,
...
// import { useTalentPriceDetailStore } from "stores/lagia-stores/travel/TalentPriceDetailStore";
// import { useAuthStore } from "src/stores/lagia-stores/auth/AuthStore";
...
//     const $store = useTalentPriceDetailStore(store);
