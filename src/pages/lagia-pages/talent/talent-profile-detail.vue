...
import { useTalentDetailStore } from "stores/lagia-stores/talent/TalentDetailStore";
...
defineOptions({
  ...
  //   return useTalentDetailStore(store).onFetch(currentRoute?.params?.slug);
  // }
  preFetch: preFetch(
    ({
      store,
...
const $store = useTalentDetailStore();
const {
  dataType,
  record,
  isMaintenance,
...
// import { useTalentDetailStore } from "stores/lagia-stores/travel/TalentDetailStore";
// import { useAuthStore } from "src/stores/lagia-stores/auth/AuthStore";
...
//     const $store = useTalentDetailStore(store);
