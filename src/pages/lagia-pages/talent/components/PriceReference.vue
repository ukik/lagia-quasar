  ...
  <q-list bordered v-if="item">
    <q-expansion-item group="somegroup1" header-class="bg-grey-1" default-opened>
      <template v-slot:header>
        ...
        <q-item-section class="text-h6 text-dark"> PROFILE TALENT </q-item-section>
      </template>
      <q-separator />

      <q-card>
        <q-card-section>
          <PriceReferenceStore :item="item?.talentProfile"></PriceReferenceStore>
        </q-card-section>
      </q-card>
    </q-expansion-item>
    ...
    <q-expansion-item group="somegroup" header-class="bg-grey-1" default-opened>
      <template v-slot:header>
        ...
        <q-item-section class="text-h6 text-dark"> DETAIL SKILL </q-item-section>
      </template>
      <q-separator />
      <q-card>
        <q-card-section>
