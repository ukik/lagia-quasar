    ...
    >
      <q-card :style="$q.screen.width > 768 ? 'width: 750px !important' : ''">
        ...
        <q-card-section style="height: calc(99.5% - 50px)" class="scroll">
          <StoreDetailBody :record="record?.transportRental"></StoreDetailBody>
        </q-card-section>
      </q-card>
    </q-dialog>

    <TransportPriceDialogDetailCard :item="record">
      <template v-slot:buttongroup="scoped">
        <q-btn-group spread unelevated>
          ...
          <q-btn @click="popup = true" label="store" icon="storefront" />
        </q-btn-group>
      </template>
    </TransportPriceDialogDetailCard>
...
import TransportPriceDialogDetailCard from "../TransportPriceDialogDetailCard";
