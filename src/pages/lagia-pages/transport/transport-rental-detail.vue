...
import { useTransportDetailStore } from "stores/lagia-stores/transport/TransportDetailStore";
...
defineOptions({
  ...
  //   return useTransportDetailStore(store).onFetch(currentRoute?.params?.slug);
  // }
  preFetch: preFetch(
    ({
      store,
...
const $store = useTransportDetailStore();
const {
  dataType,
  record,
  isMaintenance,
...
// import { useTransportDetailStore } from "stores/lagia-stores/travel/TransportDetailStore";
// import { useAuthStore } from "src/stores/lagia-stores/auth/AuthStore";
...
//     const $store = useTransportDetailStore(store);
