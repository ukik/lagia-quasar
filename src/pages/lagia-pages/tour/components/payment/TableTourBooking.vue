      ...
      <template v-slot:body="props">
        <q-tr :props="props">
          <q-td key="delete" :props="props">
            ...
            <div>
              ...
              <q-btn
                ...
                color="positive"
                icon="receipt"
                :disable="!props.row?.transaction_id"
                :to="{
              ...
              >
                <q-tooltip :offset="[0, 3]" anchor="top middle" self="bottom middle"
                  >INVOICE</q-tooltip
                >
              </q-btn>

              <q-btn-dropdown
                :disable="!props.row?.product_id"
                menu-anchor="top end" menu-self="top left" :menu-offset="[5, 0]"
                unelevated
                dense
                outline
                color="blue"
              ...
              >
                ...
                > -->
                <q-list >
                  <q-item class="bg-form text-white q-pa-none q-pr-md" dense
                    clickable
                    v-close-popup
                    :to="{
                  ...
                  >
                    <q-item-section avatar>
                      <q-avatar icon="explore"></q-avatar>
                    </q-item-section>
                    <q-item-section>
                      <q-item-label>Lihat Produk</q-item-label>
                    </q-item-section>
                  </q-item>
                  ...
                  >
                    <q-item-section avatar>
                      <q-avatar icon="shopping_cart_checkout"></q-avatar>
                    </q-item-section>
                    <q-item-section>
                      <q-item-label>Pesan Lagi</q-item-label>
                    </q-item-section>
                  </q-item>
          ...
          <q-td key="gross_amount" :props="props">
            {{ $currency(props.row.gross_amount) }}
          </q-td>
...
<style>
#PaymentBookingPage .q-table--dense .q-table th:first-child,
#PaymentBookingPage .q-table--dense .q-table td:first-child {
  padding-left: 8px;
}
</style>
