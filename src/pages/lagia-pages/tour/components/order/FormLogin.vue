<template>
  <div class="form-box">
    <q-card flat class="rounded-borders-2 bg-form">
      ...
      <q-card-section class="q-mt-md q-col-gutter-md row q-col-gutter-y-lg">
          <div class="col-12">
            <q-input
      ...
      <q-separator color="white-1"></q-separator>
      <q-card-actions class="col-12 text-center " align="between">
            <q-btn
              :loading="loading.form_login"
              :disable="loading.form_login"
              type="submit"
...
<style>
#form-career-component-100 .q-field--outlined .q-field__control:hover:before {
  border-color: #ffffff75 !important;
}
#form-career-component-100 .q-field__counter {
  color: white;
}
</style>
<style scoped>
