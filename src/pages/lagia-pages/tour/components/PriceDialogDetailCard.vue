            ...
            <q-card-section class="custom q-pa-none q-mb-md">
              <q-list class="row flex items-start text-caption text-dark q-pl-md">
                <isQItemLabelSimpleValueNoDense
                  label="uuid"
                  :value="item?.tourProduct?.uuid"
                ></isQItemLabelSimpleValueNoDense>
                <isQItemLabelSimpleValueNoDense
                  label="name"
                  :value="item?.tourProduct?.name"
                ></isQItemLabelSimpleValueNoDense>
                <isQItemLabelSimpleValueNoDense
                  label="category"
                  :value="item?.tourProduct?.category"
                ></isQItemLabelSimpleValueNoDense>
                <isQItemLabelSimpleValueNoDense
                  label="lainnya"
                  :value="item?.tourProduct?.others"
                ></isQItemLabelSimpleValueNoDense>
                ...
                <isQItemLabelSimpleValueNoDense
                  @onBubbleEvent="
                    dialog_value = true;
                    dialog_payload = {
                      value: item?.tourProduct?.description,
                      label: 'description',
                    };
                  "
                  :clickable="true"
                ...
                <isAvailable :item="item?.tourProduct?.isAvailable"></isAvailable>
              </q-list>
            </q-card-section>
          </q-card>
          <q-separator></q-separator>
