...
import { useTourPriceDetailStore } from "stores/lagia-stores/tour/TourPriceDetailStore";
...
defineOptions({
  ...
  //   return useTourPriceDetailStore(store).onFetch(currentRoute?.params?.slug);
  // }
  preFetch: preFetch(
    ({
      store,
...
const $store = useTourPriceDetailStore();
const {
  dataType,
  record,
  isMaintenance,
...
// import { useTourPriceDetailStore } from "stores/lagia-stores/travel/TourPriceDetailStore";
// import { useAuthStore } from "src/stores/lagia-stores/auth/AuthStore";
...
//     const $store = useTourPriceDetailStore(store);
