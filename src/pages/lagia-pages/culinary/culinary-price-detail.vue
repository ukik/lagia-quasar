...
import { useCulinaryPriceDetailStore } from "stores/lagia-stores/culinary/CulinaryPriceDetailStore";
...
defineOptions({
  ...
  //   return useCulinaryPriceDetailStore(store).onFetch(currentRoute?.params?.slug);
  // }
  preFetch: preFetch(
    ({
      store,
...
const $store = useCulinaryPriceDetailStore();
const {
  dataType,
  record,
  isMaintenance,
...
// import { useCulinaryPriceDetailStore } from "stores/lagia-stores/travel/CulinaryPriceDetailStore";
// import { useAuthStore } from "src/stores/lagia-stores/auth/AuthStore";
...
//     const $store = useCulinaryPriceDetailStore(store);
