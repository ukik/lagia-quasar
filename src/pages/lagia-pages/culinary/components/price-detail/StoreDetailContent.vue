    ...
    >
      <q-card :style="$q.screen.width > 768 ? 'width: 750px !important' : ''">
        ...
        <q-card-section style="height: calc(99.5% - 50px)" class="scroll">
          <StoreDetailBody :record="record?.culinaryStore"></StoreDetailBody>
        </q-card-section>
      </q-card>
    </q-dialog>

    <CulinaryPriceDialogDetailCard :item="record">
...
import CulinaryPriceDialogDetailCard from "../CulinaryPriceDialogDetailCard";
