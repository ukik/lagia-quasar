            ...
            <q-card-section class="custom q-pa-none q-mb-md">
              <q-list class="row flex items-start text-caption text-dark q-pl-md">
                <isQItemLabelSimpleValueNoDense
                  label="uuid"
                  :value="item?.culinaryProduct?.uuid"
                ></isQItemLabelSimpleValueNoDense>
                <isQItemLabelSimpleValueNoDense
                  label="name"
                  :value="item?.culinaryProduct?.name"
                ></isQItemLabelSimpleValueNoDense>
                <isQItemLabelSimpleValueNoDense
                  label="category"
                  :value="item?.culinaryProduct?.category"
                ></isQItemLabelSimpleValueNoDense>
                <isQItemLabelSimpleValueNoDense
                  label="lainnya"
                  :value="item?.culinaryProduct?.others"
                ></isQItemLabelSimpleValueNoDense>
                ...
                <isQItemLabelSimpleValueNoDense
                  @onBubbleEvent="
                    dialog_value = true;
                    dialog_payload = {
                      value: item?.culinaryProduct?.description,
                      label: 'description',
                    };
                  "
                  :clickable="true"
                ...
                <isAvailable :item="item?.culinaryProduct?.isAvailable"></isAvailable>
              </q-list>
            </q-card-section>
          </q-card>
          <q-separator></q-separator>
