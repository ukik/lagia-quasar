...
import { useCulinaryProductListStore } from "stores/lagia-stores/culinary/CulinaryProductListStore";
import { useRouter, onBeforeRouteLeave } from "vue-router";
const store = useCulinaryProductListStore();
...
defineOptions({
  preFetch: preFetch(
    ({
      ...
      return useCulinaryProductListStore(store).onFetch({
