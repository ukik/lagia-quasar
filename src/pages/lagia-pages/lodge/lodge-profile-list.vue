...
import { useLodgeProfileListStore } from "stores/lagia-stores/lodge/LodgeProfileListStore";
import { useRouter, onBeforeRouteLeave } from "vue-router";
const store = useLodgeProfileListStore();
...
defineOptions({
  preFetch: preFetch(
    ({
      ...
      return useLodgeProfileListStore(store).onFetch({
