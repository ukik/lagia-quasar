...
import { useLodgeDetailStore } from "stores/lagia-stores/lodge/LodgeDetailStore";
...
defineOptions({
  ...
  //   return useLodgeDetailStore(store).onFetch(currentRoute?.params?.slug);
  // }
  preFetch: preFetch(
    ({
      store,
...
const $store = useLodgeDetailStore();
const {
  dataType,
  record,
  isMaintenance,
...
// import { useLodgeDetailStore } from "stores/lagia-stores/travel/LodgeDetailStore";
// import { useAuthStore } from "src/stores/lagia-stores/auth/AuthStore";
...
//     const $store = useLodgeDetailStore(store);
