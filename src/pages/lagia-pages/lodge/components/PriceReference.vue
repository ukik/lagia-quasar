  ...
  <q-list bordered v-if="item">
    <q-expansion-item group="somegroup" header-class="bg-grey-1">
      <template v-slot:header>
        ...
        <q-item-section class="text-h6 text-dark"> PROFILE HOTEL </q-item-section>
      </template>
      <q-separator />
    ...
    <q-expansion-item group="somegroup" header-class="bg-grey-1">
      <template v-slot:header>
        <q-item-section avatar>
          <q-avatar color="primary" text-color="white">
            <q-icon name="meeting_room"></q-icon>
          </q-avatar>
        </q-item-section>

        <q-item-section class="text-h6 text-dark"> DETAIL KAMAR </q-item-section>
      </template>
      <q-separator />
      <q-card>
        <q-card-section>
