    ...
    >
      <q-card :style="$q.screen.width > 768 ? 'width: 750px !important' : ''">
        ...
        <q-card-section style="height: calc(99.5% - 50px)" class="scroll">
          <StoreDetailBody :record="record?.lodgeProfile"></StoreDetailBody>
        </q-card-section>
      </q-card>
    </q-dialog>

    <LodgePriceDialogDetailCard :item="record">
...
import LodgePriceDialogDetailCard from "../LodgePriceDialogDetailCard";
