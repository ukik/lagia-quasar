    ...
    >
      <q-card :style="$q.screen.width > 768 ? 'width: 750px !important' : ''">
        ...
        <q-card-section style="height: calc(99.5% - 50px)" class="scroll">
          <StoreDetailBody :record="record?.tourismVenue"></StoreDetailBody>
        </q-card-section>
      </q-card>
    </q-dialog>

    <TourismPriceDialogDetailCard :item="record">
...
import TourismPriceDialogDetailCard from "../TourismPriceDialogDetailCard";
