...
import { useTourismDetailStore } from "stores/lagia-stores/tourism/TourismDetailStore";
...
defineOptions({
  ...
  //   return useTourismDetailStore(store).onFetch(currentRoute?.params?.slug);
  // }
  preFetch: preFetch(
    ({
      store,
...
const $store = useTourismDetailStore();
const {
  dataType,
  record,
  isMaintenance,
...
// import { useTourismDetailStore } from "stores/lagia-stores/travel/TourismDetailStore";
// import { useAuthStore } from "src/stores/lagia-stores/auth/AuthStore";
...
//     const $store = useTourismDetailStore(store);
