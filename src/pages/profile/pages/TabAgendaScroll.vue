<template>
  <RecycleScroller :gridItems="gridItems" :itemSize="itemSecondarySize/gridItems" :itemSecondarySize="itemSecondarySize/gridItems" :prerender="10" :items="get_content" :min-item-size="100" class="scroller">
      <template v-slot="{ item, index, active }">
        ...
        <q-card @click="onProfileDetail({ type:'DetailAgenda', popup: true, post_id: item.id, title: 'detail agenda', index: index })" v-ripple clickable flat bordered square class="bg-black text-white" style="border-color: white;">
...
import { useListStore } from 'src/stores/profiles/musisi-agenda-list.js'
