    ...
    <q-item class="col-12 q-px-none">
      ...
      <q-item-section>
        ...
        <q-item-label caption lines="1">
          <q-chip v-if="item?.user?.id != auth_id" :disable="loading_komentar_semua_follow" clickable @click="onFollow" class="q-ma-none" :color="!item.user.follow ? 'positive' : 'primary'"
