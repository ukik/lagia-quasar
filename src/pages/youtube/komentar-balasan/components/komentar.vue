<template>
  <div class="col-12 row q-mt-md">
    <q-item class="col-12 q-px-none">
      ...
      <q-btn v-if="item.user?.id == auth_id" :disable="loading_komentar_balasan_delete_comment" :loading="loading_komentar_balasan_delete_comment" dense style="height:30px;" flat round icon="more_vert" color="dark">
        <q-menu>
