...
<q-card flat square v-if="cover && media" class="col-12 row q-mb-md">
  <q-img ref="cover" style="object-fit: cover; object-position: top; max-height: auto;" :src="imageSync(cover)" @error="handleError" loading="lazy" />
...
import axios from 'axios'
    ...
    methods: {
      ...
      onFileChangeCover(event) {
        ...
        if (media.size > maxAllowedSize) {
          // Here you can ask your users to load correct file
          vm.$q.notify({
            message: 'Maximal 25 MB',
            // caption: 'wajib login',
            color: 'red',
          })
          return
