  ...
  >
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
      <q-input
        ...
        placeholder="Tamu Dewasa"
        lazy-rules
        :rules="[(val) => !!val || '', (val) => val > 0 || '']"
        bottom-slots
        hint="Tamu Dewasa"
        error-message="Tamu Dewasa"
      >
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-xs-12">
      <q-input
        ...
        input-class="text-center"
        placeholder="Tamu Anak (2-6 thn)"
        hint="Tamu Anak (2-6 thn)"
      >
        <template v-slot:prepend>
