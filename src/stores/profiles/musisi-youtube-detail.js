...
import { useListStore } from './musisi-youtube-list.js'
import { useProfileStore } from './musisi.js'
...
export const useDetailListStore = defineStore('musisi-youtube-detail', {
  state: () => ({
  ...
  actions: {
    ...
    async delete (payload = null) {
      ...
      await useListStore().removeItem(useProfileStore().profile_detail.index);
