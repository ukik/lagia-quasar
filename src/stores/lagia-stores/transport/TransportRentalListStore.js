...
export const useTransportRentalListStore = defineStore('TransportRentalListStore', {
  id: 'TransportRentalListStore',
  ...
  actions: {
    ...
    async onFetch ({ currentPage }) {
      ...
      const response = await axios({
          url: '/trevolia-api/v1/entities/transport-rentals',
          method: 'get',
          params: {
            slug: this.slug,
            page: this.page,
      ...
      console.log('stores/lagia-stores/TransportRentalListStore 1', response?.data)
      ...
      console.log('stores/lagia-stores/TransportRentalListStore 2', this.data, this.records, this.lastPage, this.currentPage, this.perPage, this.totalItem)
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useTransportRentalListStore, import.meta.hot));
}
