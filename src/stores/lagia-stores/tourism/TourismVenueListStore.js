...
export const useTourismVenueListStore = defineStore('TourismVenueListStore', {
  id: 'TourismVenueListStore',
  ...
  actions: {
    ...
    async onFetch ({ currentPage }) {
      ...
      const response = await axios({
          url: '/trevolia-api/v1/entities/tourism-venues',
          method: 'get',
          params: {
            slug: this.slug,
            page: this.page,
      ...
      console.log('stores/lagia-stores/TourismVenueListStore 1', response?.data)
      ...
      console.log('stores/lagia-stores/TourismVenueListStore 2', this.data, this.records, this.lastPage, this.currentPage, this.perPage, this.totalItem)
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useTourismVenueListStore, import.meta.hot));
}
