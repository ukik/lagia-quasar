...
export const useCulinaryProductListStore = defineStore('CulinaryProductListStore', {
  id: 'CulinaryProductListStore',
  ...
  actions: {
    ...
    async onFetch ({ currentPage, venueId, query }) {
      ...
      const response = await axios({
          url: '/trevolia-api/v1/entities/culinary-products',
          method: 'get',
          params: {
            slug: this.slug,
            page: this.page,
      ...
      console.log('stores/lagia-stores/CulinaryProductListStore 1', response?.data)
      ...
      console.log('stores/lagia-stores/CulinaryProductListStore 2', this.data, this.records, this.lastPage, this.currentPage, this.perPage, this.totalItem)
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useCulinaryProductListStore, import.meta.hot));
}
