...
export const useCulinaryStoreListStore = defineStore('CulinaryStoreListStore', {
  id: 'CulinaryStoreListStore',
  ...
  actions: {
    ...
    async onFetch ({ currentPage }) {
      ...
      const response = await axios({
          url: '/trevolia-api/v1/entities/culinary-stores',
          method: 'get',
          params: {
            slug: this.slug,
            page: this.page,
      ...
      console.log('stores/lagia-stores/CulinaryStoreListStore 1', response?.data)
      ...
      console.log('stores/lagia-stores/CulinaryStoreListStore 2', this.data, this.records, this.lastPage, this.currentPage, this.perPage, this.totalItem)
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useCulinaryStoreListStore, import.meta.hot));
}
