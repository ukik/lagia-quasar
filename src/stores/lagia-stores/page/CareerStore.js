  ...
  actions: {
    ...
    async onFetch({ currentPage }) {
      ...
      const response = await axios({
        url: '/trevolia-api/v1/entities/page-career',
        method: 'get',
        params: {
          slug: this.slug,
          page: this.page,
      ...
      console.log('CareerStore 1', response?.data)
      ...
      console.log('CareerStore 2', this.data, this.records, this.lastPage, this.currentPage, this.perPage, this.totalItem)
