  ...
  actions: {
    ...
    async onFetch({ currentPage }) {
      ...
      const response = await axios({
        url: '/trevolia-api/v1/entities/page-testimonial',
        method: 'get',
        params: {
          slug: this.slug,
          page: this.page,
      ...
      console.log('TestimonialStore 1', response?.data)
      ...
      console.log('TestimonialStore 2', this.data, this.records, this.lastPage, this.currentPage, this.perPage, this.totalItem)
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useTestimonialStore, import.meta.hot));
}
