  ...
  actions: {
    ...
    async onFetch({ currentPage }) {
      ...
      const response = await axios({
        url: '/trevolia-api/v1/entities/page-team',
        method: 'get',
        params: {
          slug: this.slug,
          page: this.page,
      ...
      console.log('TeamStore 1', response?.data)
      ...
      console.log('TeamStore 2', this.data, this.records, this.lastPage, this.currentPage, this.perPage, this.totalItem)
