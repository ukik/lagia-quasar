  ...
  actions: {
    ...
    async onFetch({ currentPage }) {
      ...
      const response = await axios({
        url: '/trevolia-api/v1/entities/page-gallery',
        method: 'get',
        params: {
          slug: this.slug,
          page: this.page,
      ...
      console.log('GalleryStore 1', response?.data)
      ...
      console.log('GalleryStore 2', this.data, this.records, this.lastPage, this.currentPage, this.perPage, this.totalItem)
