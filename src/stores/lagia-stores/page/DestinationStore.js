  ...
  actions: {
    ...
    async onFetch({ currentPage }) {
      ...
      const response = await axios({
        url: '/trevolia-api/v1/entities/page-destination',
        method: 'get',
        params: {
          slug: this.slug,
          page: this.page,
      ...
      console.log('DestinationStore 1', response?.data)
      ...
      console.log('DestinationStore 2', this.data, this.records, this.lastPage, this.currentPage, this.perPage, this.totalItem)
