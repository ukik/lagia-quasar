...
export const useTravelStoreListStore = defineStore('TravelStoreListStore', {
  id: 'TravelStoreListStore',
  ...
  actions: {
    ...
    async onFetch ({ currentPage }) {
      ...
      console.log('stores/lagia-stores/TravelStoreListStore 1', response?.data)
      ...
      console.log('stores/lagia-stores/TravelStoreListStore 2', this.data, this.records, this.lastPage, this.currentPage, this.perPage, this.totalItem)
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useTravelStoreListStore, import.meta.hot));
}
