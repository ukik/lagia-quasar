...
export const useTourStoreListStore = defineStore('TourStoreListStore', {
  id: 'TourStoreListStore',
  ...
  actions: {
    ...
    async onFetch ({ currentPage }) {
      ...
      const response = await axios({
          url: '/trevolia-api/v1/entities/tour-stores',
          method: 'get',
          params: {
            slug: this.slug,
            page: this.page,
      ...
      console.log('stores/lagia-stores/TourStoreListStore 1', response?.data)
      ...
      console.log('stores/lagia-stores/TourStoreListStore 2', this.data, this.records, this.lastPage, this.currentPage, this.perPage, this.totalItem)
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useTourStoreListStore, import.meta.hot));
}
