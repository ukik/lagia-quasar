...
export const useTalentSkillListStore = defineStore('TalentSkillListStore', {
  id: 'TalentSkillListStore',
  ...
  actions: {
    ...
    async onFetch ({ currentPage, profileId }) {
      ...
      console.log('stores/lagia-stores/TalentSkillListStore 1', response?.data)
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useTalentSkillListStore, import.meta.hot));
}
