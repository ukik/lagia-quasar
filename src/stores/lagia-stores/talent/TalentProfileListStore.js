...
export const useTalentProfileListStore = defineStore('TalentProfileListStore', {
  id: 'TalentProfileListStore',
  ...
  actions: {
    ...
    async onFetch ({ currentPage, profileId }) {
      ...
      const response = await axios({
          url: '/trevolia-api/v1/entities/talent-profiles',
          method: 'get',
          params: {
            slug: this.slug,
            page: this.page,
      ...
      console.log('stores/lagia-stores/TalentProfileListStore 1', response?.data)
      ...
      console.log('stores/lagia-stores/TalentProfileListStore 2', this.data, this.records, this.lastPage, this.currentPage, this.perPage, this.totalItem)
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useTalentProfileListStore, import.meta.hot));
}
