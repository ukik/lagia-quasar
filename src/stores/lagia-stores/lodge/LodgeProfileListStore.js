...
export const useLodgeProfileListStore = defineStore('LodgeProfileListStore', {
  id: 'LodgeProfileListStore',
  ...
  actions: {
    ...
    async onFetch ({ currentPage }) {
      ...
      const response = await axios({
          url: '/trevolia-api/v1/entities/lodge-profiles',
          method: 'get',
          params: {
            slug: this.slug,
            page: this.page,
      ...
      console.log('stores/lagia-stores/LodgeProfileListStore 1', response?.data)
      ...
      console.log('stores/lagia-stores/LodgeProfileListStore 2', this.data, this.records, this.lastPage, this.currentPage, this.perPage, this.totalItem)
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useLodgeProfileListStore, import.meta.hot));
}
