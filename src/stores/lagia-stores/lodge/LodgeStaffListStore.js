...
export const useLodgeStaffListStore = defineStore('LodgeStaffListStore', {
  id: 'LodgeStaffListStore',
  ...
  actions: {
    ...
    async onFetch ({ currentPage }) {
      ...
      const response = await axios({
          url: '/trevolia-api/v1/entities/lodge-staffs',
          method: 'get',
          params: {
            slug: this.slug,
            page: this.page,
      ...
      console.log('stores/lagia-stores/LodgeStaffListStore 1', response?.data)
      ...
      console.log('stores/lagia-stores/LodgeStaffListStore 2', this.data, this.records, this.lastPage, this.currentPage, this.perPage, this.totalItem)
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useLodgeStaffListStore, import.meta.hot));
}
