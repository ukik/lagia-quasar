...
export const useLodgePriceListStore = defineStore('LodgePriceListStore', {
  id: 'LodgePriceListStore',
  ...
  actions: {
    ...
    async onFetch ({ currentPage }) {
      ...
      console.log('stores/lagia-stores/LodgePriceListStore 1', response?.data)
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useLodgePriceListStore, import.meta.hot));
}
