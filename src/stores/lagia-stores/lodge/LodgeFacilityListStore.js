...
export const useLodgeFacilityListStore = defineStore('LodgeFacilityListStore', {
  id: 'LodgeFacilityListStore',
  ...
  actions: {
    ...
    async onFetch ({ currentPage, venueId }) {
      ...
      const response = await axios({
          url: '/trevolia-api/v1/entities/lodge-facility',
          method: 'get',
          params: {
            slug: this.slug,
            page: this.page,
      ...
      console.log('stores/lagia-stores/LodgeFacilityListStore 1', response?.data)
      ...
      console.log('stores/lagia-stores/LodgeFacilityListStore 2', this.data, this.records, this.lastPage, this.currentPage, this.perPage, this.totalItem)
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useLodgeFacilityListStore, import.meta.hot));
}
