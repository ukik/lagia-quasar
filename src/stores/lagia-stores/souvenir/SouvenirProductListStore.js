...
export const useSouvenirProductListStore = defineStore('SouvenirProductListStore', {
  id: 'SouvenirProductListStore',
  ...
  actions: {
    ...
    async onFetch ({ currentPage, venueId }) {
      ...
      const response = await axios({
          url: '/trevolia-api/v1/entities/souvenir-products',
          method: 'get',
          params: {
            slug: this.slug,
            page: this.page,
      ...
      console.log('stores/lagia-stores/SouvenirProductListStore 1', response?.data)
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useSouvenirProductListStore, import.meta.hot));
}
