...
export const useSouvenirStoreListStore = defineStore('SouvenirStoreListStore', {
  id: 'SouvenirStoreListStore',
  ...
  actions: {
    ...
    async onFetch ({ currentPage }) {
      ...
      const response = await axios({
          url: '/trevolia-api/v1/entities/souvenir-stores',
          method: 'get',
          params: {
            slug: this.slug,
            page: this.page,
      ...
      console.log('stores/lagia-stores/SouvenirStoreListStore 1', response?.data)
      ...
      console.log('stores/lagia-stores/SouvenirStoreListStore 2', this.data, this.records, this.lastPage, this.currentPage, this.perPage, this.totalItem)
...
if (import.meta.hot) {
  import.meta.hot.accept(acceptHMRUpdate(useSouvenirStoreListStore, import.meta.hot));
}
